...
use Exception;
use PDO;
use Tiie\Data\Adapters\Result;
use Tiie\Data\functions;
...
class Adapter implements AdapterInterface, MetadataAccessibleInterface
{
     ...
     * @return int
     */
    public function count($command, array $params = array()) : int
    {
        $sql = null;
     ...
     * @return bool
     */
    public function exists($command, $params = array()) : bool
    {
